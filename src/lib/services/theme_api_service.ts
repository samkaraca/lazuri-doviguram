...
import { ThemeMetaDTO } from "../theme/theme_meta_dto";
import { ThemeRepository } from "../theme/theme_repository";
...
export default class ThemeApiService {
  ...
  getTheme = async (themeId: string): Promise<ApiResponse<Theme>> => {
    try {
